...
void geo_points_equal_float_returns_geo_err_null_pointer_result_code_when_lhs_is_null(void) {
  struct GeoPoint_float point = {0.0F, 0.0F};
  bool is_eq = false;
  enum GeoResult result = geo_points_equal_float(NULL, &point, &is_eq);
...
void geo_points_equal_float_returns_geo_err_null_pointer_result_code_when_rhs_is_null(void) {
  struct GeoPoint_float point = {0.0F, 0.0F};
  bool is_eq = false;
  enum GeoResult result = geo_points_equal_float(&point, NULL, &is_eq);
  assert(result == GEO_ERR_NULL_POINTER);
}

void geo_points_equal_float_returns_geo_success_and_is_equal_set_to_1_when_lhs_and_rhs_are_exactly_equal(void) {
  struct GeoPoint_float point1 = {1.5F, 2.0F};
  struct GeoPoint_float point2 = {1.5F, 2.0F};
  bool is_eq = false;
  enum GeoResult result = geo_points_equal_float(&point1, &point2, &is_eq);
...
void geo_points_equal_float_returns_geo_success_and_is_equal_set_to_1_when_lhs_x_and_y_and_rhs_x_and_y_are_within_epsilon(void) {
  struct GeoPoint_float point1 = {1.49999999F, 2.000000001F};
  struct GeoPoint_float point2 = {1.5F, 2.0F};
  bool is_eq = false;
  enum GeoResult result = geo_points_equal_float(&point1, &point2, &is_eq);
  assert(result == GEO_SUCCESS);
...
void geo_points_equal_float_returns_geo_success_and_is_equal_set_to_0_when_lhs_only_x_and_rhs_only_x_are_within_epsilon(void) {
  struct GeoPoint_float point1 = {2.0F, 2.000000001F};
  struct GeoPoint_float point2 = {1.5F, 2.0F};
  bool is_eq = false;
  enum GeoResult result = geo_points_equal_float(&point1, &point2, &is_eq);
  assert(result == GEO_SUCCESS);
...
void geo_points_equal_float_returns_geo_success_and_is_equal_set_to_0_when_lhs_neither_x_or_y_and_rhs_x_or_y_are_within_epsilon(void) {
  struct GeoPoint_float point1 = {2.0F, 3.0F};
  struct GeoPoint_float point2 = {1.5F, 2.0F};
  bool is_eq = false;
  enum GeoResult result = geo_points_equal_float(&point1, &point2, &is_eq);
  assert(result == GEO_SUCCESS);
...
void geo_segments_intersect_float_returns_geo_err_null_pointer_result_code_when_segment_1_is_null(void) {
  struct GeoPoint_float point1 = {2.0F, 3.0F};
  struct GeoPoint_float point2 = {1.5F, 2.0F};
  struct GeoSegment_float segment;
...
void geo_segments_intersect_float_returns_geo_err_null_pointer_result_code_when_segment_1_start_is_null(void) {
  /*struct GeoPoint_float point1 = {2.0F, 3.0F};*/
  struct GeoPoint_float point2 = {1.5F, 2.0F};
  struct GeoPoint_float point3 = {7.0F, 3.0F};
  struct GeoPoint_float point4 = {6.5F, 2.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  enum GeoResult result = 0;
  size_t intersect_count = 0;
  segment1.start = NULL;
  segment1.end = &point2;
...
void geo_segments_intersect_float_returns_geo_success_and_intersect_count_is_0_when_segments_are_parallel(void) {
  struct GeoPoint_float point1 = {0.0F, 3.0F};
  struct GeoPoint_float point2 = {3.0F, 3.0F};
  struct GeoPoint_float point3 = {0.0F, 4.0F};
  struct GeoPoint_float point4 = {3.0F, 4.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  enum GeoResult result = 0;
  size_t intersect_count = 0;
...
void geo_segments_intersect_float_returns_geo_success_and_intersect_count_is_0_when_segments_are_colinear_but_dont_intersect(void) {
  struct GeoPoint_float point1 = {0.0F, 0.0F};
  struct GeoPoint_float point2 = {1.0F, 0.0F};
  struct GeoPoint_float point3 = {2.0F, 0.0F};
  struct GeoPoint_float point4 = {3.0F, 0.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  enum GeoResult result = 0;
  size_t intersect_count = 0;
...
void geo_segments_intersect_float_returns_geo_success_and_intersect_count_is_0_when_segments_dont_intersect(void) {
  struct GeoPoint_float point1 = {0.0F, 0.0F};
  struct GeoPoint_float point2 = {1.0F, 1.0F};
  struct GeoPoint_float point3 = {2.0F, 3.0F};
  struct GeoPoint_float point4 = {3.0F, 5.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  enum GeoResult result = 0;
  size_t intersect_count = 0;
...
void geo_segments_intersect_float_returns_geo_success_and_intersect_count_is_1_when_segments_properly_intersect(void) {
  ...
  struct GeoPoint_float point1 = {0.0F, 0.0F};
  struct GeoPoint_float point2 = {1.0F, 1.0F};
  struct GeoPoint_float point3 = {0.0F, 1.0F};
  struct GeoPoint_float point4 = {1.0F, 0.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  enum GeoResult result = 0;
  size_t intersect_count = 0;
...
void geo_segments_intersect_float_returns_geo_success_and_intersect_count_is_2_when_segment_1_end_is_equal_to_segment_2_start(void) {
  ...
  struct GeoPoint_float point2 = {1.0F, 1.0F};
  struct GeoPoint_float point3 = {0.0F, 1.0F};
  struct GeoPoint_float point4 = {1.0F, 1.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  enum GeoResult result = 0;
  size_t intersect_count = 0;
...
void geo_segments_intersect_float_returns_geo_success_and_intersect_count_is_2_when_one_segment_is_section_of_other_segment(void) {
   ...
   */
  struct GeoPoint_float point1 = {0.0F, 0.0F};
  struct GeoPoint_float point2 = {2.0F, 0.0F};
  struct GeoPoint_float point3 = {1.0F, 0.0F};
  struct GeoPoint_float point4 = {1.5F, 0.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  enum GeoResult result = 0;
  size_t intersect_count = 0;
...
void geo_segments_intersect_float_returns_geo_success_and_intersect_count_is_3_when_segment_1_is_section_of_segment_2_and_share_1_end(void) {
  ...
  struct GeoPoint_float point2 = {2.0F, 0.0F};
  struct GeoPoint_float point3 = {1.0F, 0.0F};
  struct GeoPoint_float point4 = {2.0F, 0.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  enum GeoResult result = 0;
  size_t intersect_count = 0;
...
void geo_segments_intersect_float_returns_geo_success_and_intersect_count_is_4_when_segment_1_is_the_same_segment_as_segment_2(void) {
  ...
  struct GeoPoint_float point1 = {0.0F, 0.0F};
  struct GeoPoint_float point2 = {2.0F, 0.0F};
  struct GeoPoint_float point3 = {0.0F, 0.0F};
  struct GeoPoint_float point4 = {2.0F, 0.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  enum GeoResult result = 0;
...
void geo_geometry_is_closed_float_returns_geo_err_null_pointer_when_geometry_is_null(void) {
  struct GeoGeometry_float * geometry = NULL;
  bool is_closed = false;
  enum GeoResult result = geo_geometry_is_closed_float(geometry, &is_closed);
  assert(result == GEO_ERR_NULL_POINTER);
}

void geo_geometry_is_closed_float_returns_geo_err_null_pointer_when_geometry_segments_is_null(void) {
  struct GeoGeometry_float geometry;
...
void geo_geometry_is_closed_float_returns_geo_err_null_pointer_when_geometry_segment_start_is_null(void) {
  struct GeoPoint_float start1 = {0.0F, 0.0F};
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  struct GeoPoint_float start2 = {3.0F, 0.0F};
  struct GeoPoint_float start3 = {1.5F, 3.0F};
  struct GeoPoint_float end3 = {0.0F, 0.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  struct GeoSegment_float segment3;
  struct GeoSegment_float * segments[3];
  struct GeoGeometry_float geometry;
...
void geo_geometry_is_closed_float_returns_geo_err_null_pointer_when_geometry_segment_end_is_null(void) {
  ...
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  /*struct GeoPoint_float start2 = {3.0F, 0.0F};*/
  struct GeoPoint_float end2 = {1.5F, 3.0F};
  struct GeoPoint_float start3 = {1.5F, 3.0F};
  struct GeoPoint_float end3 = {0.0F, 0.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
...
void geo_geometry_is_closed_float_returns_geo_err_too_small_when_geometry_segment_count_less_than_3(void) {
  struct GeoPoint_float start1 = {2.0F, 0.0F};
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  struct GeoPoint_float start2 = {3.0F, 0.0F};
  struct GeoPoint_float end2 = {6.0F, 1.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  struct GeoSegment_float * segments[2];
  struct GeoGeometry_float geometry;
  segment1.start = &start1;
  segment1.end = &end1;
  segments[0] = &segment1;
...
void geo_geometry_is_closed_float_returns_geo_success_and_is_closed_is_false_when_nth_segments_end_doesnt_equal_n_plus_1_segment_start(void) {
  ...
  /* GAP HERE */
  struct GeoPoint_float end3 = {0.1F, 0.1F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  struct GeoSegment_float segment3;
  struct GeoSegment_float * segments[3];
...
void geo_geometry_is_simple_float_returns_geo_err_null_pointer_when_geometry_is_null(void) {
  ...
  enum GeoResult result = geo_geometry_is_simple_float(geometry, &is_simple);
  assert(result == GEO_ERR_NULL_POINTER);
}
...
void geo_geometry_is_simple_float_returns_geo_err_null_pointer_when_geometry_segments_ith_start_is_null(void) {
  ...
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  struct GeoPoint_float start2 = {3.0F, 0.0F};
  struct GeoPoint_float end2 = {3.0F, 3.0F};
  struct GeoPoint_float start3 = {3.0F, 3.0F};
  struct GeoPoint_float end3 = {0.0F, 3.0F};
  struct GeoPoint_float start4 = {0.0F, 3.0F};
  struct GeoPoint_float end4 = {0.0F, 0.0F};
  struct GeoSegment_float segment1;
  struct GeoSegment_float segment2;
  struct GeoSegment_float segment3;
  struct GeoSegment_float segment4;
  struct GeoSegment_float * segments[4];
  struct GeoGeometry_float geometry;
  segment1.start = &start1;
  segment1.end = &end1;
  segments[0] = &segment1;
...
void geo_geometry_is_simple_float_returns_geo_success_and_is_simple_is_false_when_any_segments_intersect(void) {
  struct GeoPoint_float start1 = {0.0F, 0.0F};
  struct GeoPoint_float end1 = {3.0F, 3.0F};
  struct GeoPoint_float start2 = {3.0F, 3.0F};
  struct GeoPoint_float end2 = {3.0F, 0.0F};
  struct GeoPoint_float start3 = {3.0F, 0.0F};
  struct GeoPoint_float end3 = {0.0F, 3.0F};
  struct GeoPoint_float start4 = {0.0F, 3.0F};
  struct GeoPoint_float end4 = {0.0F, 0.0F};
  struct GeoSegment_float segment1;
...
void geo_point_in_geometry_float_returns_geo_err_null_pointer_when_point_is_null(void) {
  ...
  geometry.segments = segments;
  geometry.segments_count = 3;
  enum GeoResult result = geo_point_in_geometry_float(NULL, &geometry, strict, &inside);
  assert(result == GEO_ERR_NULL_POINTER);
}
...
void geo_point_in_geometry_float_returns_geo_err_null_pointer_when_geometry_is_null(void) {
  ...
  bool strict = true;
  bool inside = false;
  enum GeoResult result = geo_point_in_geometry_float(&point, NULL, strict, &inside);
  assert(result == GEO_ERR_NULL_POINTER);
}
...
void geo_point_in_geometry_float_returns_geo_err_null_pointer_when_geometry_segments_is_null(void) {
  ...
  enum GeoResult result = geo_point_in_geometry_float(&point, &geometry, strict, &inside);
  assert(result == GEO_ERR_NULL_POINTER);
}
...
void geo_point_in_geometry_float_returns_geo_err_null_pointer_when_geometry_segments_ith_start_is_null(void) {
  bool strict = true;
  bool inside = false;
  struct GeoPoint_float point = {1.5F, 1.5F};
  struct GeoPoint_float start1 = {0.0F, 0.0F};
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  struct GeoPoint_float start2 = {3.0F, 0.0F};
  struct GeoPoint_float end2 = {3.0F, 3.0F};
...
void geo_poiny_in_geometry_returns_geo_success_and_is_inside_set_to_false_when_point_on_geometry_segment_and_strict_is_true(void) {
  bool strict = true;
  bool inside = false;
  struct GeoPoint_float point = {3.0F, 1.5F};
  struct GeoPoint_float start1 = {0.0F, 0.0F};
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  struct GeoPoint_float start2 = {3.0F, 0.0F};
  struct GeoPoint_float end2 = {3.0F, 3.0F};
...
void geo_poiny_in_geometry_returns_geo_success_and_is_inside_set_to_false_when_point_is_to_the_left_of_the_geometry_and_colinear_with_horizontal_segment(void) {
  bool strict = true;
  bool inside = false;
  struct GeoPoint_float point = {3.0F, -1.0F};
  struct GeoPoint_float start1 = {0.0F, 0.0F};
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  struct GeoPoint_float start2 = {3.0F, 0.0F};
  struct GeoPoint_float end2 = {3.0F, 3.0F};
...
void geo_poiny_in_geometry_returns_geo_success_and_is_inside_set_to_false_when_point_is_to_the_right_of_the_geometry_and_colinear_with_horizontal_segment(void) {
  bool strict = true;
  bool inside = false;
  struct GeoPoint_float point = {4.0F, 0.0F};
  struct GeoPoint_float start1 = {0.0F, 0.0F};
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  struct GeoPoint_float start2 = {3.0F, 0.0F};
  struct GeoPoint_float end2 = {3.0F, 3.0F};
...
void geo_poiny_in_geometry_returns_geo_success_and_is_inside_set_to_false_when_point_is_above_of_the_geometry_and_colinear_with_vertical_segment(void) {
  bool strict = true;
  bool inside = false;
  struct GeoPoint_float point = {0.0F, 4.0F};
  struct GeoPoint_float start1 = {0.0F, 0.0F};
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  struct GeoPoint_float start2 = {3.0F, 0.0F};
  struct GeoPoint_float end2 = {3.0F, 3.0F};
...
void geo_poiny_in_geometry_returns_geo_success_and_is_inside_set_to_false_when_point_is_below_of_the_geometry_and_colinear_with_vertical_segment(void) {
  bool strict = true;
  bool inside = false;
  struct GeoPoint_float point = {0.0F, -1.0F};
  struct GeoPoint_float start1 = {0.0F, 0.0F};
  struct GeoPoint_float end1 = {3.0F, 0.0F};
  struct GeoPoint_float start2 = {3.0F, 0.0F};
  struct GeoPoint_float end2 = {3.0F, 3.0F};
...
void geo_geometry_in_geometry_float_returns_geo_err_null_pointer_when_parent_geometry_is_null(void) {
  ...
  struct GeoPoint_float parent_vertex1 = { 0.0F, 0.0F };
  struct GeoPoint_float parent_vertex2 = { 5.0F, 0.0F };
  struct GeoPoint_float parent_vertex3 = { 5.0F, 5.0F };
  struct GeoPoint_float parent_vertex4 = { 0.0F, 5.0F };
  struct GeoPoint_float child_vertex1 = { 1.0F, 1.0F };
  struct GeoPoint_float child_vertex2 = { 3.0F, 1.0F };
  struct GeoPoint_float child_vertex3 = { 3.0F, 3.0F };
  struct GeoPoint_float child_vertex4 = { 1.0F, 3.0F };
  struct GeoSegment_float parent_segment1;
  struct GeoSegment_float parent_segment2;
  struct GeoSegment_float parent_segment3;
  struct GeoSegment_float parent_segment4;
  struct GeoSegment_float child_segment1;
  struct GeoSegment_float child_segment2;
  struct GeoSegment_float child_segment3;
  struct GeoSegment_float child_segment4;
  struct GeoSegment_float *parent_segments[4];
  struct GeoSegment_float *child_segments[4];
  struct GeoGeometry_float parent;
  struct GeoGeometry_float child;
...
void geo_geometry_in_geometry_float_returns_geo_success_and_is_inside_set_to_false_when_any_points_in_child_geometry_are_outside_parent_geometry(void) {
  ...
  struct GeoPoint_float child_vertex1 = { 1.0F, 1.0F };
  struct GeoPoint_float child_vertex2 = { 3.0F, 1.0F };
  struct GeoPoint_float child_vertex3 = { 6.0F, 3.0F }; /* outside parent */
  struct GeoPoint_float child_vertex4 = { 1.0F, 3.0F };
  struct GeoSegment_float parent_segment1;
  struct GeoSegment_float parent_segment2;
  struct GeoSegment_float parent_segment3;
...
void geo_geometry_in_geometry_float_returns_geo_success_and_is_inside_set_to_false_when_any_points_in_child_geometry_are_on_segment_of_parent_geometry_and_strict_is_true(void) {
  ...
  struct GeoPoint_float child_vertex1 = { 1.0F, 1.0F };
  struct GeoPoint_float child_vertex2 = { 3.0F, 1.0F };
  struct GeoPoint_float child_vertex3 = { 5.0F, 3.0F }; /* on parent geometry segment */
  struct GeoPoint_float child_vertex4 = { 1.0F, 3.0F };
  struct GeoSegment_float parent_segment1;
  struct GeoSegment_float parent_segment2;
  struct GeoSegment_float parent_segment3;
...
void geo_convex_hull_float_returns_geo_err_null_pointer_when_points_array_is_null(void) {
  size_t count = 5;
  struct GeoPoint_float *hull[5];
  size_t hull_size = 0;
  enum GeoResult result = geo_convex_hull_float(NULL, hull, count, &hull_size);
  assert(result == GEO_ERR_NULL_POINTER);
}
...
void geo_convex_hull_float_returns_geo_err_null_pointer_when_hull_array_is_null(void) {
  size_t count = 3;
  size_t hull_size = 0;
  struct GeoPoint_float *points[3];
  struct GeoPoint_float point1 = { 0.0F, 0.0F };
  struct GeoPoint_float point2 = { 1.0F, 0.0F };
  struct GeoPoint_float point3 = { 0.5F, 0.5F };
  points[0] = &point1;
  points[1] = &point2;
  points[2] = &point3;

  enum GeoResult result = geo_convex_hull_float(points, NULL, count, &hull_size);
  assert(result == GEO_ERR_NULL_POINTER);
}
...
void geo_convex_hull_float_returns_geo_err_too_small_when_size_is_less_than_3(void) {
  size_t count = 2;
  size_t hull_size = 0;
  struct GeoPoint_float *hull[2];
  struct GeoPoint_float *points[2];
  struct GeoPoint_float point1 = { 0.0F, 0.0F };
  struct GeoPoint_float point2 = { 1.0F, 0.0F };
  points[0] = &point1;
  points[1] = &point2;

  enum GeoResult result = geo_convex_hull_float(points, hull, count, &hull_size);
  assert(result == GEO_ERR_TOO_SMALL);
}
...
void geo_convex_hull_float_returns_geo_success_and_sets_hull_size_to_3_and_hull_has_points_in_order_when_given_points_form_triangle(void) {
  size_t count = 3;
  size_t hull_size = 0;
  struct GeoPoint_float *hull[3];
  struct GeoPoint_float *points[3];
...
void geo_convex_hull_float_returns_geo_success_and_sets_hull_size_to_5_and_hull_has_points_in_ccw_order_when_given_point_cloud(void) {
  size_t count = 7;
  size_t hull_size = 0;
  struct GeoPoint_float *hull[7];
  struct GeoPoint_float *points[7];
  struct GeoPoint_float point1 = { 1.0F, 1.0F };
  struct GeoPoint_float point2 = { 7.0F, 0.0F };
  struct GeoPoint_float point3 = { 4.0F, 2.0F };
  struct GeoPoint_float point4 = { 6.0F, 4.0F };
  struct GeoPoint_float point5 = { 3.0F, 5.0F };
  struct GeoPoint_float point6 = { 5.0F, 6.0F };
  struct GeoPoint_float point7 = { 2.0F, 7.0F };
...
void geo_convex_hull_float_returns_geo_success_and_sets_hull_size_to_4_and_hull_has_points_in_ccw_order_using_furthest_colinear_point_when_given_point_cloud_with_colinear_points(void) {
  size_t count = 6;
  size_t hull_size = 0;
  struct GeoPoint_float *hull[6];
  struct GeoPoint_float *points[6];
  struct GeoPoint_float point1 = { 0.0F, 0.0F };
  struct GeoPoint_float point2 = { 3.0F, 0.0F };
  struct GeoPoint_float point3 = { 3.0F, 1.0F };
  struct GeoPoint_float point4 = { 3.0F, 2.0F };
  struct GeoPoint_float point5 = { 3.0F, 3.0F };
  struct GeoPoint_float point6 = { 0.0F, 3.0F };
  points[0] = &point1;
  points[1] = &point6;
  points[2] = &point3;
  points[3] = &point2;
...
void geo_convex_hull_float_with_30_points_returns_geo_success_and_sets_hull_size_to_12_and_hull_has_points_in_ccw_order(void) {
  size_t count = 30;
  size_t hull_size = 0;
  struct GeoPoint_float *hull[30];
  struct GeoPoint_float *points[30];
  struct GeoPoint_float point1 = { -100.0f, 100.0f };
  struct GeoPoint_float point2 = { -125.0f, 125.0f };
  struct GeoPoint_float point3 = { -150.0f, 125.0f };
  struct GeoPoint_float point4 = { -175.0f, 100.0f };
  struct GeoPoint_float point5 = { -200.0f, 50.0f };
  struct GeoPoint_float point6 = { -200.0f, -50.0f };
  struct GeoPoint_float point7 = { -175.0f, -100.0f };
  struct GeoPoint_float point8 = { -150.0f, -125.0f };
  struct GeoPoint_float point9 = { -125.0f, -125.0f };
  struct GeoPoint_float point10 = { -100.0f, -100.0f };
  struct GeoPoint_float point11 = { 75.0f, 150.0f };
  struct GeoPoint_float point12 = { 25.0f, 200.0f };
  struct GeoPoint_float point13 = { -25.0f, 200.0f };
  struct GeoPoint_float point14 = { -75.0f, 125.0f };
  struct GeoPoint_float point15 = { -25.0f, 50.0f };
  struct GeoPoint_float point16 = { 25.0f, -50.0f };
  struct GeoPoint_float point17 = { 75.0f, -125.0f };
  struct GeoPoint_float point18 = { 25.0f, -200.0f };
  struct GeoPoint_float point19 = { -25.0f, -200.0f };
  struct GeoPoint_float point20 = { -75.0f, -150.0f };
  struct GeoPoint_float point21 = { 200.0f, 125.0f };
  struct GeoPoint_float point22 = { 150.0f, 125.0f };
  struct GeoPoint_float point23 = { 100.0f, 125.0f };
  struct GeoPoint_float point24 = { 100.0f, 50.0f };
  struct GeoPoint_float point25 = { 100.0f, 0.0f };
  struct GeoPoint_float point26 = { 150.0f, 0.0f };
  struct GeoPoint_float point27 = { 100.0f, -50.0f };
  struct GeoPoint_float point28 = { 100.0f, -125.0f };
  struct GeoPoint_float point29 = { 150.0f, -125.0f };
  struct GeoPoint_float point30 = { 200.0f, -125.0f };
  points[0] = &point1;
  points[1] = &point2;
  points[2] = &point3;
  points[3] = &point4;
...
int main(void) {
  ...
  geo_convex_hull_float_returns_geo_success_and_sets_hull_size_to_3_and_hull_has_points_in_order_when_given_points_form_triangle();
